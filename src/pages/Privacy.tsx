...
const sections = [
  {
    ...
    text: `Настоящая Политика конфиденциальности определяет порядок обработки и защиты персональных данных пользователей сайта ООО «Авис» (далее — Оператор). Оператор обеспечивает защиту персональных данных в соответствии с Федеральным законом от 27.07.2006 № 152-ФЗ «О персональных данных».`,
  },
  {
...
Для реализации указанных прав направьте запрос на электронную почту: ${import.meta.env.VITE_EMAIL || "info@example.com"}`,
  ...
  },
  {
    ...
    text: `ООО «Авис»
ИНН: 2319043732 · ОГРН: 1082319000906
Адрес: г. Сочи, ул. Пригородная, 6, офис 5
