...
const WhatsAppIcon = ({ size = 13, ...props }: { size?: number; className?: string; style?: React.CSSProperties }) => (
...
const Footer = () => {
  ...
  const contacts = useMemo(() => [
    ...
    { icon: WhatsAppIcon, text: "8 (988) 233-00-56", href: "https://wa.me/79882330056", highlight: true },
