...
const Cases = () => {
  ...
  return (
    <div>
      <SEO
        title="Проекты защиты объектов от БПЛА: кейсы и результаты | АВИС"
        description="Реальные проекты пассивной защиты энергетических объектов, транспортной инфраструктуры и КИИ от БПЛА. Фото, описания, результаты."
        keywords="защита от бпла проекты, защита объектов от дронов кейсы"
        path="/cases"
      />
      {/* Header */}
        ...
        {selected && (
          <div className="space-y-5 pt-1">
            ...
            <div className="aspect-[16/9] overflow-hidden rounded-md">
              <img src={selected.img} alt={selected.title} loading="lazy" decoding="async" className="h-full w-full object-cover" />
            </div>
