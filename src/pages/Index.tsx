  ...
  return (
    <div>
      <SEO
        ...
        description="Пассивная защита объектов от БПЛА: антидроновые сетки, бетонные ограждения, защитные шторы, убежища. Системы защиты от дронов под ключ. 200+ объектов. Бесплатный аудит."
        ...
        ogDescription="Антидроновые сетки, бетонные ограждения, защитные шторы. 200+ объектов. Монтаж под ключ."
      />
      <HeroSection />
      <SolutionsCatalog />
