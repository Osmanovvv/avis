        ...
        <div className="px-5 md:px-10 lg:container pt-10 pb-10 lg:pt-[120px] lg:pb-[120px]">
          <FadeIn direction="left">
            <div className="mb-4 lg:mb-6">
              <h2 style={{ fontSize: isMobile ? "clamp(1.8rem, 8vw, 2.4rem)" : undefined }}>
                Наши услуги
              </h2>
            </div>
            <p
              ...
              style={{
                fontSize: isMobile ? 14 : "0.9375rem",
                color: "#7a8394",
          ...
          <div ref={containerRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
            {categories.map((cat, i) => (
              ...
              >
                <Link
                  to={`/solutions/category/${cat.slug}`}
                ...
                >
                  {cat.image ? (
                    ...
                    <div
                      ...
                      style={{ background: "linear-gradient(135deg, #1a2535, #0d1118)" }}
                    />
                  )}
                  ...
                  {cat.description && (
                    <span
                      className="absolute top-3 left-3 right-3 px-3 py-1.5 rounded-lg text-[11px] font-medium tracking-wide"
                      style={{
