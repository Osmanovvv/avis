...
const Industries = () => (
  <div>
    <SEO
      ...
      description="Защита объектов энергетики, транспортной инфраструктуры и критически важных объектов от угроз БПЛА. Аудит и монтаж."
      keywords="защита объектов от бпла, защита предприятий от дронов, защита КИИ от бпла"
      path="/industries"
    />
